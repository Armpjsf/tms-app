          ...
          <PremiumCard key={driver.driverId} className={cn(
            ...
            <div className="flex flex-col items-center text-center mt-6">
                <div className="w-28 h-28 rounded-[2.5rem] bg-white/5 mb-8 flex items-center justify-center text-4xl font-black text-white italic border-4 border-white/10 shadow-3xl relative group/avatar overflow-hidden">
                    ...
                    <Badge className="absolute -bottom-2 bg-emerald-500 text-white border-4 border-[#0a0518] h-10 px-6 font-black italic tracking-widest text-lg font-bold shadow-xl">
                        RANK_{idx + 1}
                    </Badge>
                </div>
                ...
                <div className="grid grid-cols-2 gap-6 w-full">
                    <div className="bg-black/40 rounded-3xl p-6 border border-white/5 group-hover:border-primary/20 transition-all shadow-inner">
                        <p className="text-base font-bold font-black text-slate-600 uppercase mb-2 tracking-widest italic">On-Time_Rate</p>
                    ...
                    <div className="bg-black/40 rounded-3xl p-6 border border-white/5 group-hover:border-amber-500/20 transition-all shadow-inner">
                        <p className="text-base font-bold font-black text-slate-600 uppercase mb-2 tracking-widest italic">Global_Rank</p>
                ...
                <div className="mt-10 w-full pt-8 border-t border-white/5">
                     <div className="flex justify-between items-center mb-4">
                        <span className="text-base font-bold font-black text-slate-500 uppercase tracking-[0.3em] italic">Mission Integrity</span>
                        <span className="text-base font-bold font-black text-white italic">{driver.completionRate.toFixed(1)}%</span>
                     </div>
      ...
      <PremiumCard className="bg-[#0a0518]/40 border-2 border-white/5 shadow-3xl rounded-[4rem] overflow-hidden group/registry">
          <div className="p-12 border-b border-white/5 bg-black/40 flex flex-col md:flex-row justify-between items-center gap-10 relative overflow-hidden">
              ...
              <div className="relative z-10 flex items-center gap-6">
                ...
                <div>
                    ...
                    <p className="text-base font-bold font-black text-slate-500 uppercase tracking-[0.5em] mt-2 italic">Full operational stream for current epoch</p>
                </div>
              </div>
              <div className="relative z-10 w-full md:w-96 group/search">
                  ...
                  <input 
                    ...
                    className="w-full h-18 bg-[#0a0518] border-white/5 rounded-3xl pl-16 pr-8 text-lg font-bold font-black uppercase tracking-[0.2em] focus:border-primary/30 transition-all text-white placeholder:text-slate-700 italic shadow-inner"
                  />
              </div>
          </div>
            ...
            <Table>
                <TableHeader>
                    <TableRow className="border-b border-white/5 bg-white/[0.02] hover:bg-transparent">
                        <TableHead className="w-[120px] p-10 text-base font-bold font-black text-slate-500 uppercase tracking-[0.4em] italic text-center">Node_Rank</TableHead>
                        <TableHead className="p-10 text-base font-bold font-black text-slate-500 uppercase tracking-[0.4em] italic">Operator_Entity</TableHead>
                        <TableHead className="p-10 text-base font-bold font-black text-slate-500 uppercase tracking-[0.4em] italic text-center">Mission_Efficiency</TableHead>
                        <TableHead className="p-10 text-base font-bold font-black text-slate-500 uppercase tracking-[0.4em] italic text-center">Time_Sync</TableHead>
                        <TableHead className="p-10 text-base font-bold font-black text-slate-500 uppercase tracking-[0.4em] italic text-center">Sentiment</TableHead>
                        <TableHead className="p-10 text-base font-bold font-black text-slate-500 uppercase tracking-[0.4em] italic text-center">Yield_Return</TableHead>
                        <TableHead className="p-10 text-base font-bold font-black text-slate-500 uppercase tracking-[0.4em] italic text-right">Auth_Tier</TableHead>
                    </TableRow>
                </TableHeader>
                        ...
                        <TableRow key={driver.driverId} className="group/row hover:bg-white/[0.03] transition-all duration-300 border-none">
                            ...
                            <TableCell className="p-10">
                                <div className="flex items-center gap-5">
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <p className="text-base font-bold font-black text-slate-600 uppercase tracking-[0.2em]">{driver.plate}</p>
                                    </div>
                                </div>
                            </TableCell>
                            <TableCell className="p-10">
                            ...
                            <TableCell className="p-10 text-right">
                                <div className="flex flex-col items-end gap-2">
                                    <span className="text-base font-bold font-black text-white italic tracking-[0.2em] uppercase">{driver.points} PTS</span>
                                    <Badge className={cn(
          ...
          {drivers.length === 0 && (
              <div className="p-40 text-center flex flex-col items-center justify-center gap-8 bg-black/40">
                   ...
                   <p className="text-base font-bold font-black text-slate-800 uppercase tracking-[0.5em] italic">No performance packets detected for this epoch.</p>
              </div>
          )}

          <div className="p-10 bg-white/[0.02] border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
              <div className="flex items-center gap-4 text-base font-bold font-black text-slate-600 uppercase tracking-[0.4em] italic">
              ...
              <div className="flex items-center gap-4">
                  ...
                  <div className="text-base font-bold font-black text-slate-700 uppercase tracking-widest italic">v.6.4.2_TERMINAL</div>
              </div>
          </div>
      </PremiumCard>
    </div>
