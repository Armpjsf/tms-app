  ...
  return (
    <div className="space-y-12 pb-32 p-4 lg:p-10 bg-background">
      ...
      <div className="bg-background/60 backdrop-blur-3xl p-10 rounded-br-[6rem] rounded-tl-[3rem] border border-border/5 shadow-2xl relative overflow-hidden group">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-10 relative z-10">
          <div className="space-y-6">
            <Link href="/admin/analytics" className="inline-flex items-center gap-2 text-muted-foreground hover:text-purple-400 transition-all font-black uppercase tracking-[0.4em] text-base font-bold group/back italic">
            ...
            <div className="flex items-center gap-6">
              ...
              <div>
                <h1 className="text-5xl font-black text-foreground tracking-widest uppercase leading-none italic premium-text-gradient">Neural Advisory</h1>
          ...
          <div className="lg:col-span-12 space-y-16">
              ...
              <section className="space-y-10 group/maintenance">
                  <div className="flex items-center gap-6 px-4">
                      ...
                      <div>
                          <h2 className="text-3xl font-black text-foreground tracking-widest uppercase italic leading-none">Fleet Health Matrix</h2>
                          <p className="text-base font-bold font-black text-muted-foreground uppercase tracking-[0.4em] mt-2 italic">Predictive maintenance synchronization & wear analytics</p>
                      </div>
                      <div className="h-px flex-1 bg-gradient-to-r from-white/10 to-transparent" />
                  </div>
                  <div className="bg-background/40 p-1 rounded-[4rem] border border-border/5 shadow-3xl overflow-hidden relative">
              ...
              <section className="space-y-10 group/routes">
                  <div className="flex items-center gap-6 px-4">
                      ...
                      <div>
                          <h2 className="text-3xl font-black text-foreground tracking-widest uppercase italic leading-none">Route Threat Assessment</h2>
                          <p className="text-base font-bold font-black text-muted-foreground uppercase tracking-[0.4em] mt-2 italic">Operational risk profiling & anomaly detection</p>
                      </div>
                      <div className="h-px flex-1 bg-gradient-to-r from-white/10 to-transparent" />
                  </div>
                  <div className="bg-background/40 p-1 rounded-[4rem] border border-border/5 shadow-3xl overflow-hidden relative">
      ...
      <div className="py-24 border-t border-border/5 flex flex-col items-center opacity-30 hover:opacity-100 transition-opacity">
          ...
          <p className="text-base font-bold font-bold text-muted-foreground uppercase tracking-[0.5em] italic leading-relaxed text-center max-w-3xl px-12">
