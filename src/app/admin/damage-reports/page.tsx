...
const CATEGORY_STYLES: Record<string, string> = {
  ...
  'อื่นๆ': 'bg-white/5 text-slate-500 border-white/10',
}
  ...
  return (
    <DashboardLayout>
      <div className="space-y-12 pb-20 p-4 lg:p-10">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-10 bg-[#0a0518]/60 backdrop-blur-3xl p-10 rounded-br-[6rem] rounded-tl-[3rem] border border-rose-500/20 shadow-[0_30px_60px_rgba(244,63,94,0.15)] relative overflow-hidden group">
        ...
        {/* Registry Feed */}
        <PremiumCard className="bg-[#0a0518]/40 border-2 border-white/5 shadow-3xl rounded-[4rem] overflow-hidden group/feed">
          ...
          <div className="divide-y divide-white/[0.03]">
            {reports.length === 0 ? (
              ...
              reports.map((report) => {
                ...
                const categoryStyle = CATEGORY_STYLES[report.Reason_Category] || 'bg-white/5 text-slate-500 border-white/10'
                const date = new Date(report.Created_At)

                return (
                  <div key={report.id} className="p-12 flex flex-col lg:flex-row gap-12 group/row hover:bg-white/[0.02] transition-all duration-500 relative overflow-hidden">
                    ...
                    <div className="flex-shrink-0">
                         <div className={cn(
                             ...
                             statusStyle.bg, statusStyle.text, statusStyle.glow, "border-white/5"
                         )}>
                    ...
                    <div className="flex-1 space-y-8 min-w-0">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                           <div className="flex items-center gap-5 p-6 bg-white/5 rounded-3xl border border-white/5 shadow-inner group-hover/row:border-white/10 transition-all">
