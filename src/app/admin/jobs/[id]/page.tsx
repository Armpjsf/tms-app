            ...
            <div className="flex flex-wrap items-center gap-6">
              ...
              <div>
                <div className="flex items-center gap-4 mb-2">
                    <h1 className="text-5xl font-black text-foreground tracking-widest uppercase leading-none italic premium-text-gradient">Mission #{job.Job_ID}</h1>
            ...
            <CardContent className="p-12 space-y-12">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                <div className="space-y-4 p-8 bg-white/5 rounded-[2.5rem] border border-border/5 relative overflow-hidden group/entity">
                    ...
                    <label className="text-base font-bold font-black text-muted-foreground uppercase tracking-[0.4em] italic block">TARGET_ENTITY</label>
                ...
                <div className="space-y-4 p-8 bg-white/5 rounded-[2.5rem] border border-border/5 relative overflow-hidden group/vector">
                    ...
                    <label className="text-base font-bold font-black text-muted-foreground uppercase tracking-[0.4em] italic block">TRANSIT_VECTOR</label>
                  ...
                  <div className="flex-[1.5] space-y-6 relative">
                     ...
                     <div className="flex gap-6 items-start relative z-10">
                        ...
                        <div className="flex flex-col gap-1">
                            <label className="text-base font-bold font-black text-muted-foreground uppercase tracking-widest italic">ORIGIN_NODE</label>
                            <p className="text-xl font-black text-muted-foreground uppercase tracking-widest">{job.Origin_Location || "UNEXPECTED_NULL"}</p>
                        </div>
                     </div>
                     ...
                     <div className="flex gap-6 items-start relative z-10">
                        ...
                        <div className="flex flex-col gap-1">
                            <label className="text-base font-bold font-black text-muted-foreground uppercase tracking-widest italic">TERMINATION_NODE</label>
              ...
              {job.Job_Status === "Delivered" || job.Job_Status === "Completed" ? (
                                ...
                                <div className="space-y-6">
                                    ...
                                    {job.Signature_Url ? (
                                         <div className="relative h-full w-full bg-white rounded-[2.5rem] overflow-hidden border-4 border-primary/20 shadow-2xl flex items-center justify-center p-12">
                                            ...
                                            />
                                            <div className="absolute bottom-6 right-6 px-4 py-2 bg-background rounded-xl border border-primary/20 text-base font-bold font-black text-primary uppercase tracking-widest italic">AUTHENTICATED_BIO</div>
                                        </div>
                                    ) : (
                ...
                <div className="p-40 flex flex-col items-center justify-center gap-8 border-2 border-dashed border-border/5 rounded-[4rem] bg-black/20 relative overflow-hidden group/empty">
                    ...
                    <div className="text-center space-y-2 relative z-10">
                        <p className="text-xl font-black text-muted-foreground uppercase tracking-[0.4em] italic group-hover:text-white transition-colors">Awaiting Payload Delivery</p>
                        <p className="text-base font-bold font-black text-muted-foreground uppercase tracking-[0.6em] italic italic">POD_STREAM_NOT_INITIALIZED</p>
                    </div>
                </div>
              )}
            </CardContent>
                ...
                <CardContent className="p-8 space-y-8">
                    ...
                    <div className="pt-8 border-t border-border/5 space-y-4">
                        <div className="flex justify-between items-center bg-white/5 p-4 rounded-2xl border border-border/5">
                            <span className="text-base font-bold font-black text-muted-foreground uppercase tracking-widest italic">Asset Plate</span>
                        ...
                        <div className="flex justify-between items-center p-4">
                            <span className="text-base font-bold font-black text-muted-foreground uppercase tracking-widest italic">Secure Link</span>
                            <span className="text-lg font-bold font-black text-muted-foreground font-sans tracking-widest italic">@{job.Driver_ID?.toLowerCase() || "node_unbound"}</span>
                        </div>
                    </div>
            ...
            <PremiumCard className="bg-background/40 border-2 border-border/5 shadow-3xl rounded-[3rem] overflow-hidden">
                ...
                <CardContent className="p-8 space-y-6">
                     <div className="flex justify-between items-baseline p-4 bg-emerald-500/5 rounded-2xl border border-emerald-500/10">
                        <span className="text-base font-bold font-black text-muted-foreground uppercase tracking-widest italic">Entity Yield</span>
                     ...
                     <div className="flex justify-between items-baseline p-4 bg-rose-500/5 rounded-2xl border border-rose-500/10">
                        <span className="text-base font-bold font-black text-muted-foreground uppercase tracking-widest italic">Operator Cost</span>
                        <div className="text-right">
