      ...
      <div className="bg-[#0a0518]/60 backdrop-blur-3xl p-10 rounded-br-[6rem] rounded-tl-[3rem] border border-white/5 shadow-2xl relative overflow-hidden group">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-10 relative z-10">
          <div className="space-y-6">
            <Link href="/jobs/history" className="inline-flex items-center gap-2 text-slate-500 hover:text-primary transition-all font-black uppercase tracking-[0.4em] text-[10px] group/back italic">
            ...
            <div className="flex flex-wrap items-center gap-6">
              ...
              <div>
                ...
                <p className="text-[10px] font-black text-emerald-500 uppercase tracking-[0.6em] opacity-80 italic">Operational Lifecycle & Execution Telemetry</p>
              </div>
            </div>
          </div>
        ...
        <div className="lg:col-span-2 space-y-10">
          ...
          <PremiumCard className="bg-[#0a0518]/40 border-2 border-white/5 shadow-3xl rounded-[4rem] overflow-hidden group/route">
            <div className="p-10 border-b border-white/5 bg-black/40 flex items-center justify-between">
              ...
              <div className="flex items-center gap-2 px-4 py-1.5 bg-primary/10 rounded-full border border-primary/20 text-[9px] font-black text-primary uppercase tracking-widest italic animate-pulse">
                SYNC_LIVE
              </div>
            </div>
            <CardContent className="p-12 space-y-12">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                <div className="space-y-4 p-8 bg-white/5 rounded-[2.5rem] border border-white/5 relative overflow-hidden group/entity">
                    ...
                    <label className="text-[10px] font-black text-slate-600 uppercase tracking-[0.4em] italic block">TARGET_ENTITY</label>
                ...
                <div className="space-y-4 p-8 bg-white/5 rounded-[2.5rem] border border-white/5 relative overflow-hidden group/vector">
                    ...
                    <label className="text-[10px] font-black text-slate-600 uppercase tracking-[0.4em] italic block">TRANSIT_VECTOR</label>
              ...
              <div className="flex flex-col md:flex-row gap-10">
                  <div className="flex-1 p-8 bg-[#050110] rounded-[2.5rem] border border-white/5 shadow-inner">
                      ...
                      <p className="text-[9px] font-black text-slate-700 uppercase tracking-widest mt-2">// PLAN_CYCLE_ACTIVE</p>
                  </div>
                  ...
                  <div className="flex-[1.5] space-y-6 relative">
                     ...
                     <div className="flex gap-6 items-start relative z-10">
                        ...
                        <div className="flex flex-col gap-1">
                            <label className="text-[10px] font-black text-slate-600 uppercase tracking-widest italic">ORIGIN_NODE</label>
                            <p className="text-sm font-black text-slate-300 uppercase tracking-widest">{job.Origin_Location || "UNEXPECTED_NULL"}</p>
                        </div>
                     </div>
                     ...
                     <div className="flex gap-6 items-start relative z-10">
                        ...
                        <div className="flex flex-col gap-1">
                            <label className="text-[10px] font-black text-slate-600 uppercase tracking-widest italic">TERMINATION_NODE</label>
                            <p className="text-sm font-black text-white uppercase tracking-widest italic">{job.Dest_Location || "UNEXPECTED_NULL"}</p>
                        </div>
                     </div>
                  </div>
              </div>
           ...
           {routeHistory.length > 0 && (
            <PremiumCard className="bg-[#0a0518]/40 border-2 border-white/5 shadow-3xl rounded-[4rem] overflow-hidden group/map">
                <div className="p-10 border-b border-white/5 bg-black/40 flex items-center justify-between">
                    ...
                    <div className="px-4 py-1.5 bg-emerald-500/10 rounded-xl text-[9px] font-black text-emerald-500 uppercase italic">SIGNAL_STRENGTH: 100%</div>
                </div>
          ...
          <PremiumCard className="bg-[#0a0518]/40 border-2 border-white/5 shadow-3xl rounded-[4rem] overflow-hidden group/pod">
            <div className="p-10 border-b border-white/5 bg-black/40 flex items-center justify-between">
              ...
              <div className="px-4 py-1.5 bg-primary/10 rounded-xl text-[9px] font-black text-primary uppercase italic">VERIFIED_SIGNATURE</div>
            </div>
              ...
              {job.Job_Status === "Delivered" || job.Job_Status === "Completed" ? (
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                                ...
                                <div className="space-y-6">
                                    ...
                                    {reportUrl ? (
                                        <div className="relative w-full aspect-[1.4/1] bg-slate-950 rounded-[2.5rem] overflow-hidden border-2 border-white/5 group/report shadow-2xl">
                                            ...
                                            <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center backdrop-blur-sm">
                                                <a href={reportUrl} target="_blank" rel="noreferrer">
                                                    <PremiumButton className="h-14 px-8 rounded-2xl font-black uppercase tracking-widest text-xs">
                                                        OPEN_SOURCE_INTEL
                                                    </PremiumButton>
                                                </a>
                                            </div>
                                        ...
                                        <div className="p-20 text-center text-slate-700 border-2 border-dashed border-white/5 rounded-[2.5rem] bg-black/20 italic font-black uppercase tracking-widest text-[10px]">
                                ...
                                <div className="space-y-6">
                                    ...
                                    {job.Signature_Url ? (
                                         <div className="relative h-full w-full bg-white rounded-[2.5rem] overflow-hidden border-4 border-primary/20 shadow-2xl flex items-center justify-center p-12">
                                            ...
                                            />
                                            <div className="absolute bottom-6 right-6 px-4 py-2 bg-[#0a0518] rounded-xl border border-primary/20 text-[8px] font-black text-primary uppercase tracking-widest italic">AUTHENTICATED_BIO</div>
                                        </div>
                                    ) : (
                                        <div className="h-[200px] w-full rounded-[2.5rem] border-2 border-dashed border-white/5 flex flex-col items-center justify-center gap-4 text-slate-700 bg-black/20 italic font-black uppercase tracking-widest text-[10px]">
                ...
                <div className="p-40 flex flex-col items-center justify-center gap-8 border-2 border-dashed border-white/5 rounded-[4rem] bg-black/20 relative overflow-hidden group/empty">
                    ...
                    <div className="text-center space-y-2 relative z-10">
                        ...
                        <p className="text-[10px] font-black text-slate-800 uppercase tracking-[0.6em] italic italic">POD_STREAM_NOT_INITIALIZED</p>
                    </div>
                </div>
              )}
            </CardContent>
                ...
                <CardContent className="p-8 space-y-8">
                    <div className="flex items-center gap-5">
                        ...
                        <div>
                            ...
                            <div className="flex items-center gap-2 mt-1">
                                <span className="text-[9px] font-black text-slate-600 uppercase tracking-widest">ID:</span>
                                <span className="text-[10px] font-black text-primary uppercase tracking-widest">{job.Driver_ID || "---"}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="pt-8 border-t border-white/5 space-y-4">
                        <div className="flex justify-between items-center bg-white/5 p-4 rounded-2xl border border-white/5">
                            <span className="text-[10px] font-black text-slate-500 uppercase tracking-widest italic">Asset Plate</span>
                            <span className="text-sm font-black text-white uppercase font-sans tracking-widest border-b border-emerald-500/50">{job.Vehicle_Plate || "FIELD_UNIT"}</span>
                        </div>
                        <div className="flex justify-between items-center p-4">
                            <span className="text-[10px] font-black text-slate-500 uppercase tracking-widest italic">Secure Link</span>
                            <span className="text-xs font-black text-slate-400 font-sans tracking-widest italic">@{job.Driver_ID?.toLowerCase() || "node_unbound"}</span>
                        </div>
                    </div>
            ...
            <PremiumCard className="bg-[#0a0518]/40 border-2 border-white/5 shadow-3xl rounded-[3rem] overflow-hidden">
                ...
                <CardContent className="p-8 space-y-6">
                     <div className="flex justify-between items-baseline p-4 bg-emerald-500/5 rounded-2xl border border-emerald-500/10">
                        <span className="text-[10px] font-black text-slate-500 uppercase tracking-widest italic">Entity Yield</span>
                        <div className="text-right">
                            <span className="text-2xl font-black text-emerald-500 italic">฿{job.Price_Cust_Total?.toLocaleString() || "0"}</span>
                            <span className="text-[8px] font-black text-emerald-800 block uppercase tracking-widest">GROSS_FLOW</span>
                        </div>
                     </div>
                     <div className="flex justify-between items-baseline p-4 bg-rose-500/5 rounded-2xl border border-rose-500/10">
                        <span className="text-[10px] font-black text-slate-500 uppercase tracking-widest italic">Operator Cost</span>
                        <div className="text-right">
                            <span className="text-2xl font-black text-rose-500 italic">฿{job.Cost_Driver_Total?.toLocaleString() || "0"}</span>
                            <span className="text-[8px] font-black text-rose-800 block uppercase tracking-widest">YIELD_BURN</span>
                        </div>
                     </div>
                </CardContent>
            </PremiumCard>
                ...
                <PremiumCard className="bg-[#0a0518]/40 border-2 border-primary/20 shadow-3xl rounded-[3rem] overflow-hidden border-white/5">
                    ...
                    <CardContent className="p-8">
                        <div className="relative">
                            ...
                            <p className="text-xs font-bold text-slate-400 leading-relaxed uppercase tracking-wider italic pl-6">{job.Notes}</p>
                        </div>
                    </CardContent>
                </PremiumCard>
            )}
...
function StatusBadge({ status }: { status: string }) {
    ...
    return (
      <Badge variant="outline" className={cn("border px-4 py-1.5 text-[10px] font-black uppercase tracking-[0.2em] rounded-full italic transition-all shadow-lg", colorClass)}>
        {status.toUpperCase()}
      </Badge>
    )
}
