            ...
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-10 bg-[#0a0518]/60 backdrop-blur-3xl p-10 rounded-br-[6rem] rounded-tl-[3rem] border border-white/5 shadow-2xl relative overflow-hidden group">
                ...
                <div className="relative z-10 space-y-8">
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-primary uppercase tracking-[0.6em] mt-2 opacity-80 italic">{t('dashboard.subtitle')}</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex flex-col items-end gap-4 relative z-10">
                    <div className="bg-white/5 border border-white/10 px-6 py-3 rounded-2xl flex items-center gap-3 backdrop-blur-md">
                        ...
                        <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">{t('dashboard.system_integrity')}</span>
                    </div>
                    <div className="flex items-center gap-3 px-6 py-4 bg-primary/10 border border-primary/20 rounded-2xl">
                        <Activity className="text-primary" size={18} />
                        <span className="text-sm font-black text-white uppercase tracking-tighter italic">{t('notifications.status')}: NOMINAL</span>
                    </div>
                </div>
            </div>
                ...
                <div className="p-10 border-b border-white/5 bg-black/40 relative overflow-hidden flex flex-col md:flex-row md:items-center justify-between gap-8">
                    ...
                    <div className="flex items-center gap-5 relative z-10">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-black text-slate-500 uppercase tracking-[0.4em] mt-1">{t('notifications.registry_subtitle')}</p>
                        </div>
                    </div>
                    ...
                    <div className="relative z-10 w-full md:w-80 group/search">
                        ...
                        <input 
                            className="w-full h-16 bg-[#0a0518] border-white/5 rounded-3xl pl-16 pr-8 text-xs font-black uppercase tracking-widest focus:border-primary/50 transition-all text-white placeholder:text-slate-700 italic shadow-inner outline-none"
                                                ...
                                                {!isPass && (
                                                    <div className="flex flex-wrap gap-2 ml-5">
                                                        {failedItems.map(item => (
                                                            <span key={item.key} className="text-[9px] font-black text-rose-300 uppercase tracking-widest bg-rose-500/10 px-3 py-1 rounded-lg italic">
