  ...
  return (
    <DashboardLayout>
      <div className="mb-6">
        ...
        <h1 className="text-3xl font-bold text-foreground mb-2">ออกใบแจ้งหนี้ (Create Invoice)</h1>
        <p className="text-muted-foreground">เลือกลูกค้าและรายการงานเพื่อสร้างใบแจ้งหนี้</p>
      </div>
