...
function ArabicNumberToText(Number: number): string {
...
function formatBEDateRange(start: Date, end: Date): string {
...
function aggregateBillingJobs(jobs: any[], lang: 'th' | 'en' = 'th'): AggregatedItem[] {
