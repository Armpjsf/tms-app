      ...
      <div className="space-y-12 pb-20 p-4 lg:p-10">
            ...
            <div className="relative z-10 space-y-8">
                ...
                <div className="flex items-center gap-6">
                    ...
                    <div>
                        ...
                        <p className="text-[10px] font-black text-primary uppercase tracking-[0.6em] mt-2 opacity-80 italic italic">Akaunting Cloud Integration & Settlement Protocol</p>
                    </div>
                </div>
            </div>
                    ...
                    <div className="p-12 space-y-10">
                        <div className="space-y-4">
                            ...
                            <Input 
                                ...
                                disabled={!canManage}
                            />
                            <p className="text-[9px] font-black text-slate-600 uppercase tracking-widest italic ml-8">// LOCATE IN USER_PROFILE &gt; API_TOKEN WITHIN THE CLOUD NODE</p>
                        </div>

                        <div className="space-y-4">
                            <Label className="text-[10px] font-black uppercase text-primary/60 tracking-[0.4em] ml-6">AUTHORIZED_EMAIL_NULL</Label>
                            <Input 
                                type="email"
                    ...
                    <div className="p-12 space-y-10">
                        <div className="flex flex-col gap-8">
                            <div className="flex items-center justify-between p-8 bg-black/40 rounded-[2.5rem] border-2 border-white/5 relative overflow-hidden">
                                <div className="flex items-center gap-6 relative z-10">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-[9px] font-black text-emerald-500 uppercase tracking-[0.4em] italic mt-1">SYNC_PROTOCOL: ACTIVE</p>
                                    </div>
                                </div>
                            ...
                            <div className="flex flex-col gap-6">
                                <div className="flex items-center justify-center gap-6">
                                    {status === 'connected' && (
                                        <div className="flex items-center gap-3 text-[10px] font-black text-emerald-500 bg-emerald-500/10 px-8 py-3 rounded-2xl border border-emerald-500/20 shadow-2xl animate-pulse italic uppercase tracking-widest">
                                            <CheckCircle2 size={16} /> SIGNAL_ESTABLISHED
                                        </div>
                                    )}
                                    {status === 'failed' && (
                                        <div className="flex items-center gap-3 text-[10px] font-black text-rose-500 bg-rose-500/10 px-8 py-3 rounded-2xl border border-rose-500/20 shadow-2xl animate-bounce italic uppercase tracking-widest">
                                ...
                                <PremiumButton 
                                    variant="outline" 
                                    className="h-16 w-full rounded-2xl gap-4 bg-white/5 border-white/5 hover:bg-white/10 hover:border-primary/30 transition-all text-white font-black italic uppercase text-[10px] tracking-widest"
                        ...
                        {status === 'failed' && errorMsg && (
                            <div className="p-8 bg-rose-500/5 border-2 border-rose-500/10 rounded-3xl relative overflow-hidden group/error">
                                ...
                                <p className="text-[9px] font-black text-rose-500 uppercase tracking-[0.4em] mb-3 italic">DEEP_ERROR_TELEMETRY:</p>
                        ...
                        <div className="grid grid-cols-1 gap-6 pt-6">
                            <div className="p-8 bg-emerald-500/5 rounded-3xl border-2 border-emerald-500/10 flex flex-col gap-2">
                                <p className="text-[9px] font-black text-emerald-500 uppercase tracking-widest italic opacity-60">Invoicing Matrix (Customer)</p>
                            ...
                            <div className="p-8 bg-indigo-500/5 rounded-3xl border-2 border-indigo-500/10 flex flex-col gap-2">
                                <p className="text-[9px] font-black text-indigo-400 uppercase tracking-widest italic opacity-60">Settlement Matrix (Operator)</p>
        ...
        <div className="mt-20 p-12 rounded-[3.5rem] bg-indigo-500/5 border-2 border-indigo-500/10 flex flex-col md:flex-row gap-10 items-center relative overflow-hidden">
            ...
            <div className="space-y-4 text-center md:text-left flex-1">
                <p className="text-xl font-black text-indigo-400 italic uppercase tracking-widest">FISCAL_SYNCHRONIZATION_ADVISORY</p>
