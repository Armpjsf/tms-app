      ...
      <div className="space-y-12 pb-20 p-4 lg:p-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
             ...
             <div className="lg:col-span-7 space-y-10">
                <PremiumCard className="bg-background/40 border-2 border-border/5 shadow-3xl rounded-[4rem] overflow-hidden group/cred">
                    ...
                    <div className="p-12 space-y-10">
                        ...
                        <div className="space-y-4">
                            ...
                            <Input 
                                ...
                                className="h-16 bg-black/40 border-border/5 rounded-[1.5rem] focus:border-primary/50 transition-all text-foreground font-black italic tracking-widest pl-8 shadow-inner max-w-[200px]"
                                disabled={!canManage}
                            />
                        </div>
                    </div>
                ...
                <PremiumCard className="bg-background/40 border-2 border-border/5 shadow-3xl rounded-[4rem] overflow-hidden group/status">
                    ...
                    <div className="p-12 space-y-10">
                        <div className="flex flex-col gap-8">
                            <div className="flex items-center justify-between p-8 bg-black/40 rounded-[2.5rem] border-2 border-border/5 relative overflow-hidden">
                            ...
                            <div className="flex flex-col gap-6">
                                ...
                                <PremiumButton 
                                    variant="outline" 
                                    className="h-16 w-full rounded-2xl gap-4 bg-muted/50 border-border/5 hover:bg-muted/80 hover:border-primary/30 transition-all text-foreground font-black italic uppercase text-base font-bold tracking-widest"
