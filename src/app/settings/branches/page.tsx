    ...
    <DashboardLayout>
      <div className="space-y-12 pb-20 p-4 lg:p-10">
        ...
        <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
                <DialogContent className="bg-background border-border text-foreground max-w-2xl max-h-[90dvh] overflow-hidden flex flex-col p-0 shadow-[0_40px_100px_rgba(0,0,0,1)] rounded-[3rem] sm:rounded-[4rem] backdrop-blur-3xl">
