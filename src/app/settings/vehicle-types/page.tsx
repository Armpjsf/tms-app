                        ...
                        {types.map((type) => (
                            <tr key={type.type_id} className="hover:bg-gray-50 transition-colors">
                                ...
                                <td className="px-6 py-4 text-right flex justify-end gap-2">
                                    <Button size="icon" variant="ghost" className="h-8 w-8 text-emerald-500 hover:text-blue-300 hover:bg-blue-500/10" onClick={() => handleOpenEdit(type)}>
                                        <Edit size={16} />
                                    </Button>
            ...
            <DialogContent className="sm:max-w-[425px] bg-white border-gray-200 text-gray-900">
                ...
                <form onSubmit={handleSubmit} className="space-y-4 mt-4">
                    ...
                    {currentType && (
                        <div className="space-y-2">
                            ...
                            <select 
                                ...
                                className="flex h-10 w-full rounded-md border border-gray-200 bg-background px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                            >
                    ...
                    <div className="flex justify-end gap-2 pt-4">
                        ...
                        <Button type="submit" disabled={isSubmitting} className="bg-emerald-600 hover:bg-blue-700">
