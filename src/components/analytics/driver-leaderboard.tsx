      ...
      {data.map((driver, index) => (
        ...
        >
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="font-black text-foreground text-sm mb-0.5">{driver.name}</p>
              <div className="flex items-center gap-2 text-xs font-bold font-black text-muted-foreground">
          ...
          <div className="text-right">
            <p className="text-sm font-black text-foreground">{formatCurrency(driver.revenue)}</p>
            <div className="flex items-center justify-end gap-1 text-[10px] font-bold uppercase font-bold text-emerald-400">
