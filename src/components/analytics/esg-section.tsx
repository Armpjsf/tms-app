  ...
  return (
    <div className="space-y-10">
      ...
      <div className="flex items-center gap-3">
        <div className="p-2 bg-background rounded-xl text-emerald-500 shadow-lg border border-slate-800">
          <Leaf size={18} />
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        {/* Main ESG KPI */}
        <PremiumCard className="lg:col-span-2 bg-background border-none shadow-2xl relative overflow-hidden group p-10 rounded-br-[5rem] rounded-tl-[3rem]">
            ...
            <div className="mt-10 pt-8 border-t border-border/5 relative z-10">
                <div className="flex items-center justify-between mb-4">
                    <span className="text-base font-bold text-muted-foreground font-black uppercase tracking-widest italic">{t('dashboard.optimization_efficiency')}</span>
        ...
        <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-8">
             <PremiumCard className="bg-muted/50 border border-border/10 shadow-2xl p-8 rounded-br-[3rem] rounded-tl-[1.5rem] group hover:scale-[1.02] transition-transform duration-500">
                <div className="flex items-center gap-4 mb-6">
                    ...
                    <div>
                        <h4 className="text-xl font-black text-foreground uppercase tracking-tight italic">{t('dashboard.saved_distance')}</h4>
                        <p className="text-base font-bold text-muted-foreground font-bold uppercase tracking-widest">{t('dashboard.fleet_optimization')}</p>
                    </div>
                </div>
             ...
             <PremiumCard className="bg-background border-none shadow-2xl p-8 rounded-br-[3rem] rounded-tl-[1.5rem] group hover:scale-[1.02] transition-transform duration-500 border border-emerald-500/10">
                <div className="flex items-center gap-4 mb-6">
                    <div className="p-2 bg-emerald-500 rounded-xl text-white shadow-lg shadow-emerald-500/20">
                        <Leaf size={18} />
                    </div>
                    <div>
                        <h4 className="text-xl font-black text-foreground uppercase tracking-tight italic">{t('dashboard.green_protocol')}</h4>
             ...
             <PremiumCard className="md:col-span-2 bg-muted/50 border border-border/10 shadow-2xl p-8 rounded-br-[4rem] rounded-tl-[2rem] flex items-center justify-between">
                <div className="space-y-1">
                    <h4 className="text-lg font-bold font-black text-foreground uppercase tracking-widest italic">{t('dashboard.industrial_esg_rating')}</h4>
                    <p className="text-base font-bold text-muted-foreground font-bold uppercase tracking-wider">{t('dashboard.structural_sustainability_index')}</p>
                </div>
