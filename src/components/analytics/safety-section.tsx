        ...
        <PremiumCard className="bg-slate-950 border-none shadow-2xl relative overflow-hidden group p-8 rounded-br-[3rem] rounded-tl-[1.5rem]">
            ...
            <div className="flex items-center justify-between mb-6 relative z-10">
              <div className="space-y-1">
                ...
                <p className="text-base font-bold text-slate-500 font-bold uppercase tracking-widest italic">{t('dashboard.sos_trigger_log')}</p>
              </div>
        ...
        <PremiumCard className="bg-slate-950 border-none shadow-2xl relative overflow-hidden group p-8 rounded-br-[3rem] rounded-tl-[1.5rem]">
            ...
            <div className="flex items-center justify-between mb-6 relative z-10">
              <div className="space-y-1">
                ...
                <p className="text-base font-bold text-slate-500 font-bold uppercase tracking-widest italic">{t('dashboard.strategic_compliance_index')}</p>
              </div>
        ...
        <PremiumCard className="bg-slate-950 border-none shadow-2xl relative overflow-hidden group p-8 rounded-br-[3rem] rounded-tl-[1.5rem]">
            ...
            <div className="flex items-center justify-between mb-6 relative z-10">
              <div className="space-y-1">
                ...
                <p className="text-base font-bold text-slate-500 font-bold uppercase tracking-widest italic">{t('dashboard.operational_closure_registry')}</p>
              </div>
            ...
            <div className="flex items-center gap-2 mt-4 relative z-10 opacity-50">
                <p className="text-base font-bold text-slate-400 font-black uppercase tracking-widest italic">{t('dashboard.success_index')}</p>
            </div>
        </PremiumCard>
           ...
           <div className="p-10 space-y-8">
              ...
              {sos.byReason.length === 0 && (
                <div className="p-20 text-center">
                    ...
                    <p className="text-base font-bold font-black text-slate-400 uppercase tracking-widest">{t('dashboard.no_incident_data')}</p>
                </div>
              )}
           </div>
        </PremiumCard>
              ...
              <div className="divide-y divide-slate-50">
                ...
                {sos.recentAlerts.length === 0 && (
                     <div className="p-24 text-center">
                        ...
                        <p className="text-base font-bold font-black text-slate-400 uppercase tracking-widest italic">{t('safety.perimeter_secure')}</p>
                    </div>
                )}
              </div>
           </div>
