    ...
    <div className="space-y-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <PremiumCard className="bg-slate-950 border-none shadow-2xl relative overflow-hidden group p-8 rounded-br-[3rem] rounded-tl-[1.5rem]">
            ...
            <div className="flex items-center justify-between mb-6 relative z-10">
              <div className="space-y-1">
                <span className="text-rose-400 text-[10px] font-black uppercase tracking-[0.2em] italic">Distress Events</span>
                <p className="text-[8px] text-slate-500 font-bold uppercase tracking-widest italic">Cumulative SOS Trigger Log</p>
              </div>
            ...
            <div className="flex items-center gap-2 mt-4 relative z-10">
                ...
                <p className="text-[10px] text-rose-400 font-black uppercase tracking-widest italic">{sos.active} ACTIVE INTERVENTIONS</p>
            </div>
        </PremiumCard>
        ...
        <PremiumCard className="bg-slate-950 border-none shadow-2xl relative overflow-hidden group p-8 rounded-br-[3rem] rounded-tl-[1.5rem]">
            ...
            <div className="flex items-center justify-between mb-6 relative z-10">
              <div className="space-y-1">
                <span className="text-emerald-400 text-[10px] font-black uppercase tracking-[0.2em] italic">POD INTEGRITY</span>
                <p className="text-[8px] text-slate-500 font-bold uppercase tracking-widest italic">Strategic Compliance Index</p>
              </div>
        ...
        <PremiumCard className="bg-slate-950 border-none shadow-2xl relative overflow-hidden group p-8 rounded-br-[3rem] rounded-tl-[1.5rem]">
            ...
            <div className="flex items-center justify-between mb-6 relative z-10">
              <div className="space-y-1">
                <span className="text-blue-400 text-[10px] font-black uppercase tracking-[0.2em] italic">Mission Resolution</span>
                <p className="text-[8px] text-slate-500 font-bold uppercase tracking-widest italic">Operational Closure Registry</p>
              </div>
            ...
            <div className="flex items-center gap-2 mt-4 relative z-10 opacity-50">
                <p className="text-[10px] text-slate-400 font-black uppercase tracking-widest italic">CUMULATIVE SUCCESS INDEX</p>
            </div>
        </PremiumCard>
        ...
        <PremiumCard className="bg-emerald-600 border-none shadow-2xl relative overflow-hidden group p-8 rounded-br-[3rem] rounded-tl-[1.5rem]">
            ...
            <div className="flex items-center justify-between mb-6 relative z-10">
              <div className="space-y-1">
                <span className="text-emerald-100 text-[10px] font-black uppercase tracking-[0.2em] italic">Security Status</span>
                <p className="text-[8px] text-emerald-200 font-bold uppercase tracking-widest italic">Environmental Safety Thresh</p>
              </div>
              <div className="p-2 bg-white/10 rounded-xl text-white shadow-lg">
                <ShieldCheck size={16} />
              </div>
            </div>
            <div className="text-3xl font-black text-white tracking-tighter relative z-10 italic">NOMINAL</div>
            <div className="flex items-center gap-2 mt-4 relative z-10">
                <p className="text-[9px] text-white font-black uppercase tracking-widest italic flex items-center gap-2">
                    <Activity size={10} strokeWidth={3} /> BIOMETRIC SYNC ACTIVE
                </p>
            </div>
        </PremiumCard>
      </div>
        ...
        <PremiumCard className="bg-white border-none shadow-[0_30px_100px_rgba(0,0,0,0.1)] p-0 overflow-hidden rounded-br-[5rem] rounded-tl-[3rem]">
           <div className="p-8 border-b border-slate-50 bg-slate-950 relative overflow-hidden flex items-center justify-between">
              ...
              <div className="flex items-center gap-3 relative z-10">
                ...
                <div>
                  <h3 className="text-lg font-black text-white tracking-tight italic">Incident Taxonomy</h3>
                  <p className="text-rose-400 text-[9px] font-bold uppercase tracking-[0.2em]">Distress Category Distribution</p>
                </div>
              </div>
           </div>
           <div className="p-10 space-y-8">
              {sos.byReason.slice(0, 6).map((item, i) => (
                <div key={i} className="space-y-3 group/item">
                  <div className="flex justify-between items-end">
                     ...
                     <span className="text-lg font-black text-slate-900 tracking-tighter italic shadow-sm bg-slate-50 px-3 py-1 rounded-lg group-hover/item:text-rose-600 transition-colors">{item.count} EVENTS</span>
                  </div>
              ...
              {sos.byReason.length === 0 && (
                <div className="p-20 text-center">
                    ...
                    <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">No Incident Data Recorded</p>
                </div>
              )}
           </div>
        </PremiumCard>
        ...
        <PremiumCard className="bg-white border-none shadow-[0_30px_100px_rgba(0,0,0,0.1)] p-0 overflow-hidden rounded-br-[5rem] rounded-tl-[3rem]">
           <div className="p-8 border-b border-slate-50 bg-slate-950 relative overflow-hidden flex items-center justify-between">
              ...
              <div className="flex items-center gap-3 relative z-10">
                ...
                <div>
                  <h3 className="text-lg font-black text-white tracking-tight italic">Real-Time ALERT Log</h3>
                  <p className="text-blue-400 text-[9px] font-bold uppercase tracking-[0.2em]">Live Operational Security Feed</p>
                </div>
              </div>
           </div>
           <div className="p-0">
