    ...
    <div ref={ref} className="bg-white text-black p-8 font-sans w-[800px] mx-auto absolute top-[-9999px] left-[-9999px]">
      ...
      <div className="flex justify-between items-start border-b-2 border-gray-200 pb-4 mb-6">
        <div>
           ...
           <p className="text-sm text-gray-400 mt-1">Proof of Pickup (POP)</p>
        </div>
      ...
      <div className="grid grid-cols-2 gap-8 mb-8">
        ...
        <div className="space-y-2">
            ...
            <div className="space-y-3 text-sm">
                <div>
                    <span className="text-gray-400 text-xs block">ต้นทาง</span>
                    <p className="font-medium">{job.Origin_Location || "-"}</p>
                </div>
                <div>
                    <span className="text-gray-400 text-xs block">ไปส่งที่ (Destination)</span>
      ...
      <div className="flex justify-end break-inside-avoid">
        <div className="w-64 border border-slate-300 rounded p-4 text-center">
             <p className="text-xs text-gray-400 mb-2">ลายเซ็นผู้ส่งมอบสินค้า (Dispatcher Signature)</p>
