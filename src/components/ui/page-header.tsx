...
export function PageHeader({ icon, title, subtitle, badge, actions }: PageHeaderProps) {
    return (
        <motion.div
            ...
            className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 bg-card/50 p-6 lg:p-8 rounded-[2.5rem] border border-border shadow-2xl mb-8 relative overflow-hidden backdrop-blur-xl"
        >
